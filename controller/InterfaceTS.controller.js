	...
	return Controller.extend("com.automation.toolAutomationNew.controller.InterfaceTS", {
		...
		onConfirmSumit: function() {
			...
			if (this.getView().byId("oBTSubmit").getText() === "Submit") {
				...
				oCurrentView.byId("oBTHold").setVisible(true);
				oCurrentView.byId("oBTHold").setEnabled(false);
		...
		checkStatus: function() {
			...
			} else if (intData1.STATUS_TS === "ON HOLD") {
			...
			// } 
				...
				oCurrentView.byId("oBTHold").setVisible(false);
				oCurrentView.byId("oBTHold").setEnabled(false);
