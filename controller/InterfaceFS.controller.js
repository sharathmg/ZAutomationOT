	...
	return Controller.extend("com.automation.toolAutomationNew.controller.InterfaceFS", {
					...
					"Your object will be put on Hold. Do you want to continue?", {
						...
						onClose: function(oAction) {
							if (oAction === "YES") {
								...
								that.byId("idPopOverContainer").setVisible(true);
								...
								that.byId("oBTPrint").setEnabled(false);

								var oModelPF2 = new sap.ui.model.json.JSONModel();
								var oProcessFlow = oCurrentView.getModel("pf2").getData();
								oProcessFlow.lanes[0].label = "FS On Hold";
								...
								uParam.Fieldname = "STATUS_FS";
								oParam.Fieldvalue = "ON HOLD";
								that.oDataInterfaceSuccess.Status_FS = true;

								callServices.fnUpdateInMainTable(oParam, uParam, that.oDataInterfaceSuccess.Status_FS);
					...
					"Your object will be put Off Hold. Do you want to continue?", {
						...
						onClose: function(oAction) {
							...
							if (oAction === "YES") {
								...
								that.byId("oBTSubmit").setText("Submit");
								that.byId("oBTSubmit").setVisible(true);
								...
								var oModelPF2 = new sap.ui.model.json.JSONModel();
								var oProcessFlow = oCurrentView.getModel("pf2").getData();
								oProcessFlow.lanes[0].label = "FS Submitted";
								oModelPF2.setData(oProcessFlow);
					...
					"Do you want to submit the data?", {
						...
						onClose: function(oAction) {
							...
							if (oAction === "YES") {
								...
								// that.byId("oBTPrint").setEnabled(true);
								//SOC Writwick 25 July 2018
								that.getView().byId("idPopOverContainer").setVisible(true);
								that.getView().byId("idPopOverContainer").setEnabled(true);

								that.getView().byId("oBTHold").setVisible(true);
								that.getView().byId("oBTHold").setEnabled(true);

								that.getView().byId("oBTSubmit").setText("Approve");
								that.getView().byId("oBTSubmit").setVisible(true);
								that.getView().byId("oBTSubmit").setEnabled(true);
								...
								that.getView().byId("oBTPrint").setVisible(true);
								that.getView().byId("oBTPrint").setEnabled(true);
								//EOC Writwick 25 July 2018
					...
					"Do you want to Approve the data?", {
						...
						onClose: function(oAction) {
							...
							if (oAction === "YES") {
								...
								that.getView().byId("oBTSubmit").setText("Accept");
								that.getView().byId("oBTSubmit").setVisible(true);
								that.getView().byId("oBTSubmit").setEnabled(true);
		...
		checkStatus: function() {
			...
			if (intData1.STATUS === "SAVED") {
				...
				oCurrentView.byId("idPopOverContainer").setVisible(true);
				oCurrentView.byId("idPopOverContainer").setEnabled(true);

				oCurrentView.byId("oBTHold").setVisible(true);
				oCurrentView.byId("oBTHold").setEnabled(true);
				...
				oCurrentView.byId("oBTHold").setText("Off Hold");
				oCurrentView.byId("oBTHold").setVisible(true);
				oCurrentView.byId("oBTHold").setEnabled(true);
				...
				oCurrentView.byId("oBTPrint").setVisible(true);
				oCurrentView.byId("oBTPrint").setEnabled(false);
				...
				oCurrentView.byId("idPopOverContainer").setVisible(false);
				oCurrentView.byId("idPopOverContainer").setEnabled(false);
