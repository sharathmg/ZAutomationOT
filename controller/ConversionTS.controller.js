	...
	return Controller.extend("com.automation.toolAutomationNew.controller.ConversionTS", {
		...
		dataRead: function(versionNo) {
			...
			if (oDataConversion.Status_TS === 'SAVED') {
				...
				this.getView().byId("idPopOverContainerTS").setVisible(true);
				this.getView().byId("idPopOverContainerTS").setEnabled(true);
				...
				this.getView().byId("oBTHold").setVisible(true);
				this.getView().byId("oBTHold").setEnabled(true);
				this.getView().byId("oBTHold").setText("Off Hold");

				this.byId("idPopOverContainerTS").setVisible(true);
				this.byId("idPopOverContainerTS").setEnabled(true);

				this.byId("oBTSubmit").setVisible(true);
				this.byId("oBTSubmit").setEnabled(false);

				this.byId("oBTApprove").setVisible(false);
				this.byId("oBTApprove").setEnabled(false);

				this.byId("oBTAcceptApproval").setVisible(false);
				this.byId("oBTAcceptApproval").setEnabled(false);

				this.byId("oBTSave").setVisible(true);
				this.byId("oBTSave").setEnabled(false);

				this.byId("idPrintScreen").setVisible(true);
				this.byId("idPrintScreen").setEnabled(false);

				var oModelPF2 = new sap.ui.model.json.JSONModel();
				var oProcessFlow = this.getView().getModel("pf2").getData();
				oProcessFlow.lanes[0].label = "TS On Hold";
				oModelPF2.setData(oProcessFlow);

				this.getView().byId("processflow2").getLanes()[0].getState()[0].state = sap.suite.ui.commons.ProcessFlowNodeState.Negative;
				this.getView().byId("processflow2").getLanes()[1].getState()[0].state = sap.suite.ui.commons.ProcessFlowNodeState.Neutral;
				this.getView().setModel(oModelPF2, "pf2");
				this.getView().byId("processflow2").updateModel();
				//EOC Writwick 20 July 2018
				...
				this.byId("oBTApprove").setVisible(true);
				this.byId("oBTApprove").setEnabled(false);

				this.getView().byId("oBTSave").setVisible(true);
				this.getView().byId("oBTSave").setEnabled(false);

				this.byId("idPrintScreen").setVisible(true);
				this.byId("idPrintScreen").setEnabled(true);

				this.byId("oBTSubmit").setVisible(false);
				this.byId("oBTAcceptApproval").setVisible(false);
				...
				"Do You want to save the data", {
					...
					onClose: function(oAction) {
						...
						if (oAction === "YES") {
							...
							that.getView().byId("oBTHold").setVisible(true);
							that.getView().byId("oBTHold").setEnabled(true);
							that.getView().byId("idPopOverContainerTS").setVisible(true);
							that.getView().byId("idPopOverContainerTS").setEnabled(true);
		...
		onConfirmSave: function() {
			...
			//SOC Writwick 18 July 2018
			sap.m.MessageToast.show("Data saved");
			//EOC Writwick 18 July 2018
		...
		onHold: function() {
			...
			//SOC Writwick 19 July 2018
			var that = this;
			var sHoldText = that.getView().byId("oBTHold").getText();
			if (sHoldText === "On Hold") {
				sap.m.MessageBox.show(
					"Your object will be put on Hold. Do you want to continue?", {
						icon: sap.m.MessageBox.Icon.INFORMATION,
						title: "Confirm",
						actions: [sap.m.MessageBox.Action.YES, sap.m.MessageBox.Action.NO],
						onClose: function(oAction) {
							...
							if (oAction === "YES") {
								...
								that.getView().byId("oBTHold").setText("Off Hold");

								that.byId("idPopOverContainerTS").setVisible(true);
								that.byId("idPopOverContainerTS").setEnabled(true);

								that.byId("oBTSubmit").setVisible(true);
								that.byId("oBTSubmit").setEnabled(false);

								that.byId("oBTApprove").setVisible(false);
								that.byId("oBTApprove").setEnabled(false);

								that.byId("oBTAcceptApproval").setVisible(false);
								that.byId("oBTAcceptApproval").setEnabled(false);

								that.byId("oBTSave").setVisible(true);
								that.byId("oBTSave").setEnabled(false);

								that.byId("idPrintScreen").setVisible(true);
								that.byId("idPrintScreen").setEnabled(false);

								var oModelPF2 = new sap.ui.model.json.JSONModel();
								var oProcessFlow = oCurrentView.getModel("pf2").getData();
								oProcessFlow.lanes[0].label = "TS On Hold";
								oModelPF2.setData(oProcessFlow);

								oCurrentView.byId("processflow2").getLanes()[0].getState()[0].state = sap.suite.ui.commons.ProcessFlowNodeState.Negative;
								oCurrentView.byId("processflow2").getLanes()[1].getState()[0].state = sap.suite.ui.commons.ProcessFlowNodeState.Neutral;
								oCurrentView.setModel(oModelPF2, "pf2");
								oCurrentView.byId("processflow2").updateModel();

								oParam.Fieldname = "Status_TS";
								uParam.Fieldname = "Status_TS";
								oParam.Fieldvalue = "ON HOLD";
								that.oDataConversionSuccess.Status_FS = true;
								callServices.fnUpdateInMainTable(oParam, uParam, that.oDataConversionSuccess.Status_FS);
								// this.getView().byId("oBTHold").setText("Off Hold");
								// that.byId("idPopOverContainer").setEnabled(true);
								// that.byId("idPopOverContainer").setEnabled(true);
								...
								sap.m.MessageToast.show("Your object has been put on Hold");
							}
				...
				sap.m.MessageBox.show(
					"Your object will be put Off Hold. Do you want to continue?", {
						icon: sap.m.MessageBox.Icon.INFORMATION,
						title: "Confirm",
						actions: [sap.m.MessageBox.Action.YES, sap.m.MessageBox.Action.NO],
						onClose: function(oAction) {
							...
							if (oAction === "YES") {
								...
								that.getView().byId("oBTHold").setText("On Hold");

								that.byId("idPopOverContainerTS").setVisible(true);
								that.byId("idPopOverContainerTS").setEnabled(true);

								that.byId("oBTSubmit").setVisible(true);
								that.byId("oBTSubmit").setEnabled(true);
								...
								var oModelPF2 = new sap.ui.model.json.JSONModel();
								var oProcessFlow = oCurrentView.getModel("pf2").getData();
								oProcessFlow.lanes[0].label = "TS Completed";
								oModelPF2.setData(oProcessFlow);
								...
								sap.ui.getCore().oMessagePopover.setVisible(true);
								// that.getReviewData(false);
								sap.m.MessageToast.show("Your object has been put out of Hold");
							}
				...
				"Do You want to Approve the data", {
					...
					onClose: function(oAction) {
						...
						if (oAction === "YES") {
							...
							that.getView().byId("oBTHold").setEnabled(false);
							that.getView().byId("oBTHold").setVisible(true);

							that.byId("oBTApprove").setVisible(true);
							that.byId("oBTApprove").setEnabled(false);
		...
		showBusyIndicator: function() {
			window._busyIndicator = new sap.m.BusyDialog({
				showCancelButton: false
					// text: Processing
			});
			window._busyIndicator.open();
		},

		hideBusyIndicator: function() {
			if (window._busyIndicator) {
				window._busyIndicator.close();
				window._busyIndicator = null;
			}
		}
	});
